        ...
        myChart = new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Restaurants by Cuisine Types'
                    }
                },
                scales: {
                    x: {
                        title: {
                            display: true,   
                            text: 'Cuisine Type' // Just wanted to add an X axis label as well
                        }
                    },
                    y: {
                        beginAtZero: true,
...
function createMyMap() {
    ...
    try {
        ...
        restaurants.forEach(function(restaurant, index) {
            ...
            // const popupContent = ...;
            const popupContent = `
                <p><b>${restaurant.name}</b><br></p>
                <p>Cuisine: ${restaurant.cuisine}<br></p>
